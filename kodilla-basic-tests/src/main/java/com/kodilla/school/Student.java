...
public class Student {
    ...
    private Grades maths;           // obiekty typu grades
    ...
    public void addMathGrade(int grade) {   //metoda dodająca ocenę do poszczególnego przedmiotu
        if (grade > 0 && grade < 7) {
    ...
    public double getMathsAverage() {           // zwraca srednią ocen z danego przedmiotu
